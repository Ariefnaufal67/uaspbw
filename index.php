...
<html lang="en">
  ...
  <body>
        ...
        <div id="carouselExample" class="carousel slide">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="arkan.jpg" class="d-block w-100" alt="..." />
            </div>
            <div class="carousel-item">
              <img src="zia.jpg" class="d-block w-100" alt="..." />
            </div>
            <div class="carousel-item">
              <img src="naufal.jpg" class="d-block w-100" alt="..." />
            </div>
          ...
          <div class="row row-cols-1 row-cols-md-4 g-4 justify-content-center">
              ...
              <div class="card h-100">
                ...
                <ul class="list-group list-group-flush">
                  <li class="list-group-item">
                    Pemrograman Berbasis Web<br />12.30-14.10 | D.2.J
                  </li>
                </ul>
              </div>
            </div>
            <div class="col">
              <div class="card h-100">
                ...
                <ul class="list-group list-group-flush">
                  ...
                  <li class="list-group-item">
                    BASIS DATA<br />16.20-18.00 | D.3.M
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div class="col">
              <div class="card h-100">
                ...
                <ul class="list-group list-group-flush">
                  <li class="list-group-item">
                   Logika Informatika<br />07.00-09.30 | H.4.5
                  </li>
                  <li class="list-group-item">
                    Rekayasa Perangkat Lunak<br />12.30-15.00 | H.4.12
                  </li>
                  <li class="list-group-item">
        ...
        <div class="container">
          <div class="d-sm-flex align-items-center justify-content-center">
            ...
            <div class="p-md-5 text-sm-start">
              <h3 class="lead">A11.2023.14931</h3>
              <h1 class="fw-bold">Muhammad Arkan Bahi Syauqi</h1>
    ...
    <footer id="footer" class="text-center p-5">
        <div>
          <a href="https://www.instagram.com/pekochan.11"
            ><i class="bi bi-instagram h2 p-2"></i
          ></a>
          <a href="https://twitter.com/udinusofficial"
            ><i class="bi bi-twitter h2 p-2"></i
          ></a>
          <a href="https://wa.me/+6281362253779"
            ><i class="bi bi-whatsapp h2 p-2"></i
          ></a>
        </div>
        <div>Muhammad Arkan Bahi Syauqi &copy; 2025</div>
    </footer>
    <!-- footer end -->
